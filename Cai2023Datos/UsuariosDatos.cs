...
namespace Cai2023Datos
{
...

    {
        ...
        public List<Usuario> TraerUsuariosActivos()
        {
            ...
            HttpResponseMessage response = WebHelper.Get("Usuario/TraerUsuariosActivos?id="+idusuario);
        ...
        {
            string idUsuarioMaster = "D347CE99-DB8D-4542-AA97-FC9F3CCE6969";//hardcode de id usuario admin
            Dictionary<String, String> map = new Dictionary<String, String>();
        ...
        public void ReactivarUsuario(string idUsuario)
        {
            ...
            HttpResponseMessage response = WebHelper.Patch("Usuario/BajaUsuario", jsonRequest);
